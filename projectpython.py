...
label0= Label(root,text="           ACCOUNT MANAGEMENT SYSTEM", font=("Helvetica", 30))
label0.grid(columnspan=6, padx=10, pady=10)

label1=Label(root,text='Enter Amount',font=("Helvetica", 12))
...
label3=Label(root,text='Enter Reason',font=("Helvetica", 12))
label3.grid(row=8,column=0, sticky=W, padx=10, pady=10)

label4=Label(root,text='Credit',font=("Helvetica", 12))
label4.grid(row=9,column=0, sticky=W, padx=10, pady=10)

label5=Label(root,text='Debit',font=("Helvetica", 12))
...
button1=Button(root,text='Add Entry', bg="white", fg="red", width=20, font=("Helvetica", 12))
button1.bind('<Button-1>',addrecord)
button1.grid(row=12,column=0,padx=4, pady=10)

button2=Button(root,text='Remove Details', bg="white", fg="green", width=20, font=("Helvetica", 12))
button2.bind('<Button-1>',removerecord)
button2.grid(row=12,column=1,padx=4, pady=10)

button3=Button(root,text='Search Record', bg="white", fg="orange", width=20, font=("Helvetica", 12))
button3.bind('<Button-1>',searchrecord)
button3.grid(row=12,column=2,padx=4, pady=10)

button4=Button(root,text='Update Details', bg="white", fg="purple", width=20, font=("Helvetica", 12))
button4.bind('<Button-1>',updaterecord)
button4.grid(row=13,column=0,padx=4, pady=10)

button5=Button(root,text='View Next Record', bg="white", fg="brown", width=20, font=("Helvetica", 12))
button5.bind('<Button-1>',nextrecord)
button5.grid(row=13,column=1,padx=4, pady=10)

button6=Button(root,text='View Previous Record', bg="white", fg="dark green", width=20, font=("Helvetica", 12))
button6.bind('<Button-1>',prevrecord)
button6.grid(row=14,column=2,padx=4, pady=10)


button7=Button(root,text='View Last Record', bg="white", fg="blue", width=20, font=("Helvetica", 12))
button7.bind('<Button-1>',lastrecord)
button7.grid(row=13,column=2,padx=4, pady=10)

button8=Button(root,text='View First Record', bg="white", fg="purple", width=20, font=("Helvetica", 12))
button8.bind('<Button-1>',firstrecord)
button8.grid(row=14,column=0,padx=4, pady=10)

button8=Button(root,text='Reset', bg="white", fg="brown", width=20, font=("Helvetica", 12))
